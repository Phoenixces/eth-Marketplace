        ...
        <div className="max-w-5xl mx-auto">
          { courseState === "purchased" &&
            <Message type="warning">
              ...
              <i className="block font-normal">In case of any questions, please contact info@WeCode.com</i>
            </Message>
          }
          { courseState === "activated" &&
            <Message type="success">
              WeCode wishes you happy watching of the course.
            </Message>
          }
          { courseState === "deactivated" &&
            <Message type="danger">
              ...
              <i className="block font-normal">Please contact info@WeCode.com</i>
            </Message>
          }
        </div>
      }
